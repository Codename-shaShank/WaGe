...
const VenuePage = (props) => {
    document.title = "WaGe | Work Details";
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="table-responsive">
                                ...
                                <table className="table table-sm table-borderless mb-0">
                                    <tbody>
                                        <tr>
                                            <th className="pl-0 w-25" scope="row"><strong>Worker Name</strong></th>
                                            {
                                                auth.token === null ?
...
//   document.title = 'WaGe | Venue Details';
//   const dispatch = useDispatch();
//   const auth = useSelector((state) => state.auth);
//   const [bookingModalShow, setBookingModalShow] = useState(false);
//   const oneVenueInfo = useSelector(state => state.oneVenueInfo);
//   const { _id, venueName, description, address, location, category, price, venuePictures, ownerInfo, reviews, ownerId } = oneVenueInfo.venue;
//   useEffect(() => {
//     const { params } = match;
