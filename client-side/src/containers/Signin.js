                    ...
                    <Row className='text-center'>
                        <Col md="auto" className="d-flex justify-content-center">
                            <Card style={{ width: '18rem', marginTop: "30px" }}>
                                ...
                                <Card.Body>
                                    <Button variant="outline-dark" onClick={() => setUserModalShow(true)}>Hirer/User</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md="auto" className="d-flex justify-content-center">
                            <Card style={{ width: '18rem', marginTop: "30px" }}>
                                ...
                                <Card.Body>
                                    <Button variant="outline-dark" onClick={() => setDealerModalShow(true)}>Worker</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                    </Row>
